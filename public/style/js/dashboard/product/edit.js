...
const keywords = [];
const keywrodsInJson = window.keywords;
for (let index in keywrodsInJson) {
    keywords.push(keywrodsInJson[index]['content']);
}

const selectedKeywords = [];
const selectedKeywordsInJson = window.selectedKeywords;
for (let index in selectedKeywordsInJson) {
    selectedKeywords.push(selectedKeywordsInJson[index]['content']);
}
